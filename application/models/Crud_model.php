...
class Crud_model extends CI_Model {
    ...
    //parent details 
    function getStudentAddress($address_id)
    {
         $query = $this->db->get_where('stu_address', array('stu_add_id' => $address_id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['stu_add'];
    }
    ...
    ////////////CLASS///////////
    function get_fee_category_name($fee_category_id) {
        $query = $this->db->get_where('fee_category', array('fee_category_id' => $fee_category_id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['fee_category_name'];
    }
