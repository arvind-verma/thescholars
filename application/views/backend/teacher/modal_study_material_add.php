<?php
$class_info = $this->db->query("select class.* from class inner join section on class.class_id = section.class_id where section.teacher_id='".$this->session->userdata("teacher_id")."' group by class.class_id")->result_array();
//$class_info = $this->db->get_where('class',array("teacher_id"=>$this->session->userdata("teacher_id")))->result_array(); 
?>
<div class="row">
    <div class="col-md-12">
