    ...
    <div class="col-md-12">
        ...
        <div class="tab-pane  <?php if (!isset($edit_data) && !isset($personal_profile) && !isset($academic_result)) echo 'active'; ?>" id="list">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="class_id" class="form-control"  onchange="show_subjects(this.value)"  style="float:left;">
                                ...
                                <?php
                                $classes = $this->db->query("select class.* from class inner join section on class.class_id = section.class_id where section.teacher_id='" . $this->session->userdata("teacher_id") . "' group by section.class_id")->result_array();
                            ...
                            foreach ($classes as $row):
                                ...
                                ?>" 
                                    ...
                                    foreach ($subjects as $row2):
                                        ...
                                        <?php
                                        if (isset($subject_id) && $subject_id == $row2['subject_id'])
            ...
            <?php if ($exam_id > 0 && $class_id > 0 && $subject_id > 0): ?>
                ...
                <?php
                $sections = $this->db->get_where("section", array("class_id" => $class_id, "teacher_id" => $this->session->userdata("teacher_id")))->result_array();
                foreach ($sections as $section):
                   echo "<h4>".$section["name"]."(".$section["nick_name"].")</h4>";
                    ?>
                    <?php
                    ////CREATE THE MARK ENTRY ONLY IF NOT EXISTS////
                    $students = $this->crud_model->get_students1($class_id,$section["section_id"]);
