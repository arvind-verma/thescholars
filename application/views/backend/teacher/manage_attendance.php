...
<?php if ($date != '' && $month != '' && $year != '' && $class_id != ''): ?>
    ...
    <div class="row" id="attendance_list">
        ...
        foreach ($sections as $section):
            echo "<br clear=all><h4 align='center'>" . $section["name"] . "(" . $section["nick_name"] . ")</h4>";
            ?>
            <div class="col-sm-offset-3 col-md-6">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php
                        $students = $this->db->get_where('student', array('class_id' => $class_id, "section_id" => $section["section_id"]))->result_array();
