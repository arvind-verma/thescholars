    ...
    <div class="form-group">
        ...
        <select class="form-control select2" name="reciever" required>
            ...
            <optgroup label="<?php echo get_phrase('student'); ?>">
                ...
                $students = $this->db->query("select student.* from student inner join section on student.section_id = section.section_id where section.teacher_id='".$this->session->userdata("teacher_id")."'")->result_array();
