        ...
        <div class="tab-content">
            <div class="tab-pane active" id="home">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        <?php
                        $students = $this->db->query("select student.* from student inner join section on student.section_id = section.section_id where section.teacher_id='" . $this->session->userdata("teacher_id") . "' and student.class_id='" . $class_id . "'")->result_array();
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                            ...
                                            <li>
                                                <a href="<?php echo base_url("teacher/student_edit/" . $row['student_id']); ?>">
