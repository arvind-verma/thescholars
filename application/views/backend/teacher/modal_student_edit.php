...
<div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-5 control-label"><?php echo get_phrase('aadhar_card_file'); ?></label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-5 control-label"><?php echo get_phrase('medical_certificate'); ?></label>
                        <div class="col-sm-5">
                            <input type="file" class="form-control" name="medical_certificate" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="field-1" class="col-sm-5 control-label"><?php echo get_phrase('birth_certificate'); ?></label>
                        <div class="col-sm-5">
