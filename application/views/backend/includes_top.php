...
<link rel="stylesheet" href="<?php echo site_url('assets/css/select2/select2-bootstrap.css'); ?>" id="style-resource-1">
<link rel="stylesheet" href="<?php echo site_url('assets/css/select2/select2.css'); ?>s" id="style-resource-2"> 
