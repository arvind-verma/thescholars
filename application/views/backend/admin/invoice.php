        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <th><div><?php echo get_phrase('total_with_concession'); ?></div></th>
                    ...
                    <tbody>
                        <?php foreach ($invoices as $row): ?>
                            <tr>
                                ...
                                <td><?php 
                                $fee_title = $this->db->get_where("fee_category",array("fee_category_id"=>$row['title']))->row_array();
                                echo $fee_title["fee_category_name"];
                                ?></td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                            ...
                                            <?php if ($row['due'] != 0): ?>
                                                ...
                                                <li>
                                                    <a href="<?php echo base_url('admin/takepayment/' . $row['invoice_id']) ?>">
                        ...
                        <div class="panel panel-default panel-shadow" data-collapsed="0">
                            ...
                            <div class="panel-body">
                                <script>
                                    $(document).ready(function() {
                                        ...
                                        $("#ajaxstudent").change(function() {
                                            $.ajax({
                                                url: "<?php echo base_url(); ?>admin/getstudentfee",
                                                data: "student_id=" + $(this).val(),
                                                dataType: "json",
                                                success: function(result) {
                                                    $("#feetable").html(result.text);
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="student_id" class="select2 form-control" id="ajaxstudent" style="" >
                                            <?php
                                            ...
                                            foreach ($students as $row):
                                                ...
                                                <option value="<?php echo $row['student_id']; ?>">
                                                    ...
                                                    <?php echo $row['name']; ?> (<?php echo $row['admission_no']; ?>)
                                                </option>
                                                <?php
                                            endforeach;
                                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="title">
                                            ...
                                            <?php
                                            $result = $this->db->get("fee_category")->result_array();
                                            foreach ($result as $row_category) {
                                                echo "<option value='" . $row_category["fee_category_id"] . "'>" . $row_category["fee_category_name"] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                        ...
                        <div class="panel panel-default panel-shadow" data-collapsed="0">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="total_amount" name="amount"
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo get_phrase('concession'); ?></label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="concession"
                                               placeholder="<?php echo get_phrase('enter_concession_amount'); ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="method" class="form-control">
                                            ...
                                            <option value="4"><?php echo get_phrase('draft'); ?></option>
                                        </select>
                                    </div>
                                </div>
