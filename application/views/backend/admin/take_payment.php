                        ...
                        <tbody>
                            ...
                            foreach ($payments as $row2):
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        $fee_title = $this->db->get_where("fee_category", array("fee_category_id" => $row2['title']))->row_array();
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('admin/payment_draft/' . $row2["payment_id"] . '/' . $row['invoice_id']) ?>" class="label label-default"><i class="fa fa-print"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default panel-shadow" data-collapsed="0">
                ...
                <div class="panel-body">
                    <?php
                    echo form_open(base_url() . 'admin/invoice/take_payment/' . $row['invoice_id'], array(
