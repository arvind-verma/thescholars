...
<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        <?php foreach ($edit_data as $row): ?>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><?php echo get_phrase('barcode_no'); ?></label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="barcode_no" value="<?php echo $row['barcode_no']; ?>"/>
                </div>
            </div>
            <div class="form-group">
