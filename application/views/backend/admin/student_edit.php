                ...
                <div class="row">
                    <div class="col-lg-3 table-responsive edusec-pf-border no-padding edusecArLangCss" style="margin-bottom:15px">
                        <div class="col-md-12 text-center">
                            <img class="img-circle edusec-img-disp" src="<?php echo $this->crud_model->get_image_url('student', $student_info['student_id']); ?>" style="width:150px;height:150px;padding:10px;" alt="No Image">		
                    ...
                    <div class="col-lg-9 profile-data">
                        ...
                        <div id="content" class="tab-content responsive">
                                ...
                                if (empty($student_info["parent_id"])) {
                                    ...
                                    <div>
                                        <center>Add New Parent: <a id="update-data" class="btn btn-success btn-sm" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_parent_add/<?php echo $student_info['student_id']; ?>');"><i class="fa fa-pencil-square-o"></i> Add New</a>	
                                            <br><br>or<br></br>
                                            <?php echo form_open(base_url() . 'admin/parent/update/' . $student_info["student_id"], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                                            Select Parent(Existing)
                                            <select name="parent_id" class="form-control select2" style="width:300px;">
                                ...
                                if (empty($student_info["address_id"])) {
                                    ...
                                    <div>
                                        <center>Add New Parent: <a id="update-data" class="btn btn-success btn-sm" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_address_add/<?php echo $student_info['student_id']; ?>');"><i class="fa fa-pencil-square-o"></i> Add New</a>	
                                            <br><br>or<br></br>
                                            <?php echo form_open(base_url() . 'admin/student/updateadd/' . $student_info["student_id"], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                                            Select Parent(Existing)
                                            <select name="address_id" class="form-control select2" style="width:300px;">
                            ...
                            <div class="tab-pane" id="documents">
                                ...
                                <?php echo form_open(base_url() . 'admin/student/documents/' . $student_info["student_id"], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                                <div class="col-md-4">
                                            ...
                                            if (count($documents) > 0) {
                                                foreach ($documents as $document) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url("admin/student/deldoc/" . $document["stu_docs_id"] . "/" . $student_info["student_id"]) ?>" class="label label-danger" onclick="return confirm('Do you want to delete it?')"><i class="fa fa-trash-o"></i> Delete</a>
                                                        </td>
