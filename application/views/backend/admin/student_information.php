                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                            ...
                                            <li>
                                                <a href="<?php echo base_url(); ?>admin/student/identity_card/<?php echo $row['student_id']; ?>" >
                                                    <i class="entypo-user"></i>
                                                    <?php echo get_phrase('identity_card'); ?>
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="<?php echo base_url("admin/student_edit/" . $row['student_id']); ?>">
                                                    <i class="entypo-pencil"></i>
                                                    <?php echo get_phrase('edit/view'); ?>
                                                </a>
                                            </li>
                                            <li class="divider"></li>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                    ...
                                                    <!-- STUDENT PROFILE LINK -->
                                                    <li>
                                                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>admin/student/i_card/<?php echo $row['student_id']; ?>');">
                                                            <i class="entypo-user"></i>
                                                            <?php echo get_phrase('i_card'); ?>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_student_profile/<?php echo $row['student_id']; ?>');">
