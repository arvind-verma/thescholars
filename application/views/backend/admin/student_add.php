...
if(!empty($param1))
{
    $enquiry_row = $this->db->get_where("stu_enquiry",array("stu_enquiry_id"=>$param1))->row_array(); 
}
?>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" data-validate="required" data-message-required="<?php echo get_phrase('value_required'); ?>" value="<?php if(isset($enquiry_row["name"])) echo  $enquiry_row["name"];?>" autofocus>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" name="birthday" value="<?php if(isset($enquiry_row["dob"])) echo $enquiry_row["dob"];?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required'); ?>" data-start-view="2">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="sex" class="form-control" required="">
                                    ...
                                    <option value="male" <?php if(isset($enquiry_row["gender"])){ if($enquiry_row["gender"] == "male") echo "selected";  }?>><?php echo get_phrase('male'); ?></option>
                                    <option value="female" <?php if(isset($enquiry_row["gender"])){ if($enquiry_row["gender"] == "female") echo "selected";  }?>><?php echo get_phrase('female'); ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="phone" value="<?php if(isset($enquiry_row["phone"])) echo $enquiry_row["phone"];?>" >
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="hidden" name="admission_by_enquiry" value="<?php if(isset($enquiry_row["stu_enquiry_id"])) echo $enquiry_row["stu_enquiry_id"];?>"/>
