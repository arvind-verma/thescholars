<div class="row">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <th><div><?php echo get_phrase('vehicle_no'); ?></div></th>
                    <th><div><?php echo get_phrase('seats'); ?></div></th>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                            ...
                                            <!-- EDITING LINK -->
                                            <li>
                                                <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_vehicle/<?php echo $row['vehicle_id']; ?>');">
    ...
    <?php echo get_phrase('edit'); ?>
                                            ...
                                            <!-- DELETION LINK -->
                                            <li>
                                                <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>admin/vehicle_detail/delete/<?php echo $row['vehicle_id']; ?>');">
...
<?php echo form_open(base_url() . 'admin/vehicle_detail/create', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="driver_id" class="form-control">
                                <option value=""><?php echo get_phrase('select'); ?></option>
                                <?php
                                $parents = $this->db->get('driver_detail')->result_array();
                                foreach ($parents as $row):
                                    ?>
